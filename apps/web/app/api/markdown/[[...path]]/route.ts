...
function renderHome(): string {
  return [
    ...
    `REST: https://api.modelpedia.dev/v1/models, /v1/providers, /v1/stats`,
    `MCP: https://api.modelpedia.dev/mcp (Streamable HTTP, no auth)`,
  ].join("\n");
}
...
function renderApiDocs(): string {
  return [
    "# API Reference",
    "",
    "- REST: `https://api.modelpedia.dev/v1`",
    "- MCP: `https://api.modelpedia.dev/mcp`",
    "",
    "JSON · No authentication · CORS enabled · REST rate limit: 60 req/min per IP",
    "",
    "## MCP Setup",
    "",
    "Streamable HTTP transport. No auth required, no rate limit.",
    "",
    "```",
    ...
    "| list_models | List/filter/sort models |",
    "| get_model | Get model by provider and ID |",
    "| compare_models | Compare models side by side |",
    "| recommend_models | Recommendations by capability, price, modality |",
    "| compare_pricing | Compare pricing across models |",
    "| search | Search providers and models |",
    "| list_capabilities | List capabilities with counts |",
    "| list_families | List model families |",
    "",
    "## REST Endpoints",
    "",
    ...
    "| GET /v1/models/recommend | Model recommendations |",
    "| GET /v1/families | Model families |",
    "| GET /v1/capabilities | All capabilities |",
    "| GET /v1/pricing/compare | Compare pricing |",
    "",
